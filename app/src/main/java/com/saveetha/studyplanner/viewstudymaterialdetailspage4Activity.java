...
public class viewstudymaterialdetailspage4Activity extends AppCompatActivity {

    private Button nextPageBtn4, prevPageBtn4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize views
        nextPageBtn4 = findViewById(R.id.nextPageBtn4);
        prevPageBtn4 = findViewById(R.id.prevPageBtn4);
        bookImageView = findViewById(R.id.bookImageView);
        zoomInBtn = findViewById(R.id.zoomInBtn);
        zoomOutBtn = findViewById(R.id.zoomOutBtn);

        // Next Page (Page 5)
        nextPageBtn4.setOnClickListener(v -> {
            Intent intent = new Intent(viewstudymaterialdetailspage4Activity.this, viewstudymaterialdetailspage5Activity.class);
            startActivity(intent);
            finish();
        });

        // Previous Page (Page 3)
        prevPageBtn4.setOnClickListener(v -> {
            Intent intent = new Intent(viewstudymaterialdetailspage4Activity.this, ViewStudyMaterialDetailPage3Activity.class);
            startActivity(intent);
            finish();
        });
